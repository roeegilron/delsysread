...
axes(haxDelAcc); 
hold on; 
xx = dataraw.DBS_5Hz_1_ACCX1_IM_;
yy = dataraw.DBS_5Hz_1_ACCY1_IM_;
zz = dataraw.DBS_5Hz_1_ACCZ1_IM_;
...
%%
% set up video 
v = VideoWriter('Run_number_198_Plot_and_Store_Rep_2_And_Video.mp4','MPEG-4'); 
...
curPos = params.delsysStart - params.delsys5Hz + seconds(53); % this syncs it up with RCS
vidCam.CurrentTime = vidCam.CurrentTime + 53;
% XXXXX
